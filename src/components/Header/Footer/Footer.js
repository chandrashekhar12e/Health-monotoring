...
function Copyright(props) {
    return (
        <Typography variant="body2" color="text.secondary" align="center" {...props}>
            {'Developed with 🖤 by '}
            <strong><a className='text-style' href="https://github.com/Foy5al" target="_blank" rel="noreferrer noopener">Chandrashekhar</a> </strong>{'Copyright ©'}
                        ...
                        <Grid sx={{ m: 'auto' }} item xs={12} sm={6} md={4}>
                            ...
                            <Stack direction="row"
                                ...
                                <Avatar sx={{ mt: 1, bgcolor: pink[500] }}>
                                    <LocationOnIcon />
                                </Avatar><span>GLA University Mathura-2814000</span>
                            </Stack >
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href=" chandrashekhar12e@gmail.com">
                                   chandrashekhar12e@gmail.com
                                </a>
                            </Stack >
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="Mobile no-56345637256">
                                    4534542656
                                </a>
                            </Stack >
